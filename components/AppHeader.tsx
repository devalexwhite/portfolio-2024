...
export default function AppHeader({
  ...
  return (
    <motion.header
      ...
      className=" from-slate-100 to-slate-200 bg-gradient-to-b rounded-full my-8 sm:my-16 px-8 py-3 not-prose grid grid-cols-3"
    >
      <Link href="/" className="flex flex-row items-center gap-1 group">
        ...
        <div className="font-bold hidden sm:block text-sm text-slate-700">
          Go Back
        </div>
      </Link>
